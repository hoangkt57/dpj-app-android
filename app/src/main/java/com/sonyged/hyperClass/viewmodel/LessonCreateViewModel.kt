...
//                Timber.d("loadTeacher - teacherResponse: $teacherResponse")
    ...
    fun createLesson(
        ...
        viewModelScope.launch(Dispatchers.Default) {
            ...
            if (startTime == null || endTime == null || date == -1L) {
            ...
            if (diff < 15 * 60 || (isRepeatEnable && isUntil && endDate != -1L && endDate < date)) {
            ...
            val endAfterDate = if (isUntil && endDate != -1L) {
